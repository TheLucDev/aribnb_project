...
import Place1 from "../../../assets/1.jpeg";
          ...
          <div>
            ...
            >
              ...
              <div className="absolute top-4 left-1/2 transform -translate-x-1/2">
                <p className="text-center text-lg">{vitri.province}</p>
                <p className="text-lg text-center py-5">{vitri.name}</p>
  ...
  return (
    <div>
      <div className="relative ">
        <img src={HomeImg} className=" object-cover object-center mx-auto" />
      ...
      <div className="container my-5  grid grid-cols-4 gap-4 mx-auto py-5 lg:z-0 md:z-0 sm:z-0">
        {renderLocation()}
      </div>
